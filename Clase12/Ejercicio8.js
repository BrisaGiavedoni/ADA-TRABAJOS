...
for (let i = 0; i < matriz.length; i++) {
  diagonalRoja.push(matriz[i][i]);  
}

let sumaRoja = 0; 

for (let i = 0; i < diagonalRoja.length; i++) {
  sumaRoja += diagonalRoja[i]; 
}
console.log("La diagonal roja: " + sumaRoja);

let diagonalVerde = [];

for (let i = 0; i < matriz.length; i++) {
    diagonalVerde.push(matriz[i][matriz.length - 1 - i]);  
}
...
console.log("La diagonal verde: " + sumaVerde);