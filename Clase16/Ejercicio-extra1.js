...
let personas= ['Lucía', 'Ana', 'María', 'Luis', 'José']

let nombresCortos = personas.filter(nombre => nombre.length < 5);

let nombresEnMayusculas = nombresCortos.map(nombre => nombre.toUpperCase());

let frase = "Los nombres seleccionados son: " + nombresEnMayusculas.join(" , ");
